                ...
                <div class="container row d-flex justify-content-center">
                    <div class="row justify-content-center">
                        <div class="card shadow-lg border-5 rounded-lg mt-5 col-md-3 col-sm-12 mb-3 ">         
                            <div class="card-header py-5"><h3 class="text-center text-uppercase">Total Jumlah</h3></div>                                                                                   
                            <div class="card-body ">
                                <div class="row justify-content-center">
                        ...
                        <div class="card shadow-lg border-5 rounded-lg mt-5 col-md-9 col-sm-12 mb-3 "> 
                            <div class="card-header py-5"><h3 class="text-center text-uppercase">History Pesanan</h3></div>                                                                                           
                            <div class="card-body ">
                        ...
                        <div class="container row d-flex justify-content-center">
                            <div class="card shadow-lg border-5 rounded-lg mt-5 col-md-12 col-sm-12 mb-3 "> 
                                <div class="card-header py-5"><h3 class="text-center text-uppercase">Jadwalmu hari ini</h3></div>                                                                                           
                                <div class="card-body ">
                                    <div class="row justify-content-center table table-responsive">
                                    <table class="table table-responsive">
                                    <thead>
